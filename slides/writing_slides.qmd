...
![Accessing the "Markdown Quick Reference" Guide inside of RStudio](/assets/quarto-images/qmd-annotations/markdown-cheatsheet.png){fig-alt="Opening the built-in Markdown quick reference sheet inside of RStudio by going to the help menu and selecting 'Markdown Quick Reference'."}
...
You can also use the **Visual Editor** in [VS Code](https://quarto.org/docs/visual-editor/vscode/), [RStudio](https://quarto.org/docs/visual-editor/), or \[Positron\](<https://positron.posit.co/>) to see Markdown syntax previewed in it's final format as you write. The Visual Editor also has some common Word-like shortcuts, such as `Ctrl + B` to make text bold.
...
![](/assets/gifs/table.gif){fig-align="center" width="626"}
